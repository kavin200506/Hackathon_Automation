...
class StudentSetPasswordScreen extends StatefulWidget {
  const StudentSetPasswordScreen({super.key});

  @override
  State<StudentSetPasswordScreen> createState() =>
      _StudentSetPasswordScreenState();
}

class _StudentSetPasswordScreenState extends State<StudentSetPasswordScreen> {
  ...
  Future<void> _handleSetPassword() async {
    ...
    try {
      // Step 1: Set password
      await AuthAPI.studentSetPassword({
        'email': _email,
        'password': _passwordController.text,
      });

      // Step 2: Auto-login
      final loginResponse = await AuthAPI.studentLogin({
        'email': _email,
        'password': _passwordController.text,
      });
      ...
      final userJson = (loginResponse['user'] ?? loginResponse['student'] ?? {})
